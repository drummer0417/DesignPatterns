package nl.androidappfactory.designpatterns.visitor;
...
class TaxVisitor implements Visitor {
	...
	public double visit(Liquor liquorItem) {
		...
		return Double.parseDouble(df.format((liquorItem.getPrice() * 1.18) + liquorItem.getPrice()));
	}
	...
	public double visit(Tobacco tobaccoItem) {
		...
		return Double.parseDouble(df.format((tobaccoItem.getPrice() * 1.32) + tobaccoItem.getPrice()));
	}
